...
public class MergeSortSingleList {
    ...
    public static void main(String[] args) {
    	...
    	printList(new MergeSortSingleList().sortList(buildList(new int[]{3, 2, 4})));
    	printList(new MergeSortSingleList().sortList(buildList(new int[]{3})));
    	printList(new MergeSortSingleList().sortList(buildList(new int[]{3, 2})));
