...
public class SortSingleList {
    ...
    public static void main(String[] args) {
    	...
    	printList(new SortSingleList().sortList(buildList(new int[]{3, 2, 4})));
    	printList(new SortSingleList().sortList(buildList(new int[]{3})));
    	printList(new SortSingleList().sortList(buildList(new int[]{3, 2})));
